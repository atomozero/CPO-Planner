# Generated by Django 4.2.9 on 2025-04-10 21:41
...
import projects.models.document
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('cpo_core', '0004_alter_project_expected_completion_date_and_more'),
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('logo', models.ImageField(blank=True, null=True, upload_to=projects.models.project.project_logo_path, verbose_name='Logo Progetto')),
                ('region', models.CharField(default='Italia', max_length=100, verbose_name='Regione')),
                ('start_date', models.DateField(blank=True, null=True, verbose_name='Data Inizio Progetto')),
                ('expected_completion_date', models.DateField(blank=True, null=True, verbose_name='Data Prevista Completamento')),
                ('actual_completion_date', models.DateField(blank=True, null=True, verbose_name='Data Effettiva Completamento')),
                ('total_budget', models.DecimalField(decimal_places=2, default=0, max_digits=15, verbose_name='Budget Totale')),
                ('total_expected_revenue', models.DecimalField(decimal_places=2, default=0, max_digits=15, verbose_name='Ricavi Attesi Totali')),
                ('total_roi', models.DecimalField(blank=True, decimal_places=2, default=0, max_digits=10, null=True, validators=[django.core.validators.MinValueValidator(Decimal('-99.99')), django.core.validators.MaxValueValidator(Decimal('9999.99'))], verbose_name='ROI Totale')),
                ('loan_amount', models.DecimalField(decimal_places=2, default=0, max_digits=12, verbose_name='Importo Prestito')),
                ('loan_interest_rate', models.DecimalField(decimal_places=2, default=0, max_digits=5, verbose_name='Tasso di Interesse')),
                ('loan_term_years', models.PositiveIntegerField(default=10, verbose_name='Durata Prestito (anni)')),
                ('pre_amortization_years', models.PositiveIntegerField(default=0, verbose_name='Anni di Preammortamento')),
                ('status', models.CharField(choices=[('planning', 'Pianificazione'), ('approval', 'In Approvazione'), ('in_progress', 'In Corso'), ('construction', 'In Costruzione'), ('operational', 'Operativo'), ('maintenance', 'In Manutenzione'), ('completed', 'Completato'), ('suspended', 'Sospeso'), ('closed', 'Chiuso')], default='planning', max_length=20, verbose_name='Stato Progetto')),
                ('photovoltaic_integration', models.BooleanField(default=False, verbose_name='Integrazione Fotovoltaico')),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('municipality', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='project_app_projects', to='infrastructure.municipality', verbose_name='Comune principale')),
                ('organization', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='projects_app_projects', to='cpo_core.organization')),
                ('project_manager', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='projects_app_managed_projects', to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=255, verbose_name='Nome Stazione')),
                ('description', models.TextField(blank=True, null=True, verbose_name='Descrizione')),
                ('address', models.CharField(blank=True, max_length=255, null=True, verbose_name='Indirizzo')),
                ('latitude_proposed', models.DecimalField(blank=True, decimal_places=6, max_digits=9, null=True, verbose_name='Latitudine Proposta')),
                ('longitude_proposed', models.DecimalField(blank=True, decimal_places=6, max_digits=9, null=True, verbose_name='Longitudine Proposta')),
                ('latitude_approved', models.DecimalField(blank=True, decimal_places=6, max_digits=9, null=True, verbose_name='Latitudine Approvata')),
                ('longitude_approved', models.DecimalField(blank=True, decimal_places=6, max_digits=9, null=True, verbose_name='Longitudine Approvata')),
                ('charger_brand', models.CharField(blank=True, max_length=100, null=True, verbose_name='Marca Colonnina')),
                ('charger_model', models.CharField(blank=True, max_length=100, null=True, verbose_name='Modello Colonnina')),
                ...
                ('ground_area_sqm', models.DecimalField(blank=True, decimal_places=2, max_digits=6, null=True, verbose_name='Area Occupata (m²)')),
                ('start_date', models.DateField(verbose_name='Data Inizio')),
                ('expected_completion_date', models.DateField(verbose_name='Data Prevista Completamento')),
                ('weekly_market_day', models.CharField(blank=True, choices=[('', '-- Nessuno --'), ('monday', 'Lunedì'), ('tuesday', 'Martedì'), ('wednesday', 'Mercoledì'), ('thursday', 'Giovedì'), ('friday', 'Venerdì'), ('saturday', 'Sabato'), ('sunday', 'Domenica')], max_length=10, null=True, verbose_name='Giorno Mercato Settimanale')),
                ('local_festival_days', models.PositiveSmallIntegerField(default=0, verbose_name='Giorni Festa Locale/Anno')),
                ('rainy_days', models.PositiveSmallIntegerField(default=0, help_text="Giorni di pioggia stimati che riducono l'utilizzo delle colonnine", verbose_name='Giorni di Pioggia Previsti/Anno')),
                ('budget', models.DecimalField(decimal_places=2, max_digits=12, verbose_name='Budget Totale')),
                ('expected_revenue', models.DecimalField(decimal_places=2, max_digits=12, verbose_name='Ricavi Attesi')),
                ('roi', models.DecimalField(decimal_places=2, default=0, max_digits=10, validators=[django.core.validators.MinValueValidator(Decimal('-99.99')), django.core.validators.MaxValueValidator(Decimal('9999.99'))], verbose_name='ROI')),
                ('equipment_cost', models.DecimalField(blank=True, decimal_places=2, max_digits=10, null=True, verbose_name='Costo Colonnina')),
                ('installation_cost', models.DecimalField(blank=True, decimal_places=2, max_digits=10, null=True, verbose_name='Costo Installazione')),
                ('connection_cost', models.DecimalField(blank=True, decimal_places=2, max_digits=10, null=True, verbose_name='Costo Allaccio Rete')),
                ('permit_cost', models.DecimalField(blank=True, decimal_places=2, max_digits=10, null=True, verbose_name='Costo Permessi')),
                ('civil_works_cost', models.DecimalField(blank=True, decimal_places=2, max_digits=10, null=True, verbose_name='Costo Opere Civili')),
                ('other_costs', models.DecimalField(blank=True, decimal_places=2, max_digits=10, null=True, verbose_name='Altri Costi')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('file', models.FileField(upload_to=projects.models.document.station_document_path, verbose_name='File')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('file', models.FileField(upload_to=projects.models.document.project_document_path, verbose_name='File')),
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='Data creazione')),
                ('updated_at', models.DateTimeField(auto_now=True, verbose_name='Data aggiornamento')),
                ('project', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='proj_documents', to='projects.project', verbose_name='Progetto')),
            ],
            options={
